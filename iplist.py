...
def dec2bin80(string_num):  # 十进制0~255转化为二进制,补0到8位
...
def dec2bin320(string_num):  # 十进制0~255转化为二进制,补0到32位
...
def dec2bin(string_num):  # 十进制0~255转化为二进制，不补零
...
def bin2dec(string_num):  # 二进制转换为十进制

    return str(int(string_num, 2))


def iplist(string_startip,string_endip):  # ip列表生成
